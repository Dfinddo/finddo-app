...
export default class PerfilScreen extends Component {
	...
	obterFoto = () => {
		...
		const {id} = TokenService.getInstance().getUser();
	...
	public render() {
		...
		const tintColor = colors.amareloIconeEditar;
				...
				<ImageBackground
								...
								</KeyboardAvoidingView>
								{
									(() => {
										...
										if (user.user_type === "professional") {
											...
											const {connectWirecardUrl} = ambienteASerConstruido.moipCredsData;
														...
														<View>
															<Text
																...
																onPress={() => {
																	...
																	Linking.openURL(user.set_account);

																}}>Configurar recebimento de pagamentos</Text>
															<Text
																style={[styles.perfilEnderecoSelect, {marginTop: 10}]}
																onPress={() => {

																	Linking.openURL(urlAuthorization);

																}}>Autorizar transações</Text>
														</View>
													);
										...
										return (
											<View>
												...
												<Text
													...
													}}>Forma de pagamento padrão</Text>
											</View>);
					...
					<View style={{
						...
						<TouchableOpacity
							...
							}/* this.login(this.state.usuario, this.state.senha)*/}>
