				...
				<View style={{
					...
					<TouchableOpacity
						...
						onPress={() => {
							...
							this.props.navigation.navigate("CreateEditAddress");
						...
						return (
							<View style={{
								...
								<TouchableOpacity onPress={() => {
									...
									props.navigation.navigate("CreateEditAddress", {endereco: props.dados.item, editar: true});
								...
								<TouchableOpacity onPress={() => {
									...
									excluirItemConfirm(props.dados.item, props.comp, props.size);
