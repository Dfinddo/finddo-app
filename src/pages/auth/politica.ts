...
Quando você realiza alguma transação com nosso aplicativo, como parte do processo de compra e venda, coletamos as informações pessoais que você nos dá tais como: nome, e-mail e endereço.

Quando você acessa nosso aplicativo, também recebemos automaticamente o protocolo de internet do seu dispositivo, endereço de IP, a fim de obter informações que nos ajudam a aprender sobre seu navegador e sistema operacional.

Email Marketing será realizado apenas caso você permita. Nestes emails você poderá receber notícia sobre nosso aplicativo, novos produtos e outras atualizações.
...
Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco em daniel@finddo.com.br ou nos enviando uma correspondência em: Finddo: Finddo serviços de manutenção e tecnologia ltda. - EPP Estrada Vereader Alceu de Carvalho, nº 665, casa o-4-2, Recreio dos Bandeirantes, Rio de Janeiro, RJ, cep.: 22790-881
SEÇÃO 3 - DIVULGAÇÃO
...
Uma vez que você deixe o nosso aplicativo ou seja redirecionado para um aplicativo ou site de terceiros, você não será mais regido por essa Política de Privacidade ou pelos Termos de Serviço do nosso aplicativo.

Links

Quando você clica em links no nosso aplicativo, eles podem lhe direcionar para fora do nosso aplicativo. Não somos responsáveis pelas práticas de privacidade de outros sites e lhe incentivamos a ler as declarações de privacidade deles.
SEÇÃO 5 - SEGURANÇA
...
Se nosso aplicativo for vendido ou fundido com outra empresa, suas informações podem ser transferidas para os novos proprietários para que possamos continuar a vender produtos para você.
SEÇÃO 7 - ACESSO A CÂMERA E MICROFONE DO USUÁRIO

Caso o usuário do tipo cliente deseje coletar informações para melhor explicar o problema em fotos e/ou vídeos, o aplicativo terá que ter acesso a câmera do usuário e microfone do usuário, para isso basta apenas o usuário Permitir o acesso, o aviso de solicitação de permissão é feito no primeiro momento em que a câmera e/ou o microfone for(em) acessado(s).
`;
